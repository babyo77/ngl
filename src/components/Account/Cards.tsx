...
const Cards = React.forwardRef<HTMLDivElement,{ msg: string,ref2:React.RefObject<HTMLDivElement> }>(({ msg ,ref2 },ref) => {
  return (
    <div>

<div ref={ref} className="w-[300px] hidden  h-[300px]    flex-col items-center" >
    ...
    <Card ref={ref2} className="rounded-3xl border-none shadow-none w-[90dvw] m-0 p-0" >
