...
export function DrawerCard({msg,id,seen,time,country,city,regionName}:{msg:string,id:string,seen:boolean,time:Timestamp,country:string,city:string,regionName:string}){
